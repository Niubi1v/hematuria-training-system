...
const rules = Object.freeze([
  ...
  ["medication_list", (text) => has(text, /(?:平时|平常|长期|常年|每天|固定|常规|规律|常用|常备|早晚|天天|一直备着).{0,14}(?:药|服用|服药|吃|用药)|(?:药|药物|服药|用药).{0,12}(?:平时|平常|长期|常年|每天|固定|常规|规律|常用|天天)|用药史|处方药|药物方面|列一张单子|慢性病.{0,8}吃什么药/) && !has(text, /过敏|allerg/)],
  ...
  ["prior_diagnosis_patient_aware", (text) => has(text, priorDiagnosisContext) && has(text, /诊断|病名|啥病|什么病|疾病名称|病因|怎么定性|认为是什么|什么问题|啥毛病|起过名|明确叫过什么|说您得的是啥|医生.{0,12}(?:下个说法|啥说法|说啥病|怎么说的|咋跟你讲|告诉)|大夫.{0,12}(?:说法|讲|告诉)|外院.{0,12}(?:说法|结论)/) && !has(text, /检查|化验|片子|报告|结果|结论|尿一验/)],
  ...
  ["treatment_response", (text) => has(text, /治疗反应|管用|管事|见效|效果|好转|好些|好点|缓解|松快|改善|维持|复发|还犯|照旧|减少|恢复|有效|有没有用|还在吗|治后怎样|之后怎么样|以后怎么样|药物带来的变化|治疗.{0,8}怎么样|处理.{0,8}怎么样|吃药.{0,8}怎么样|用药.{0,8}怎么样|输液.{0,8}怎么样|(?:处理|治疗|治(?:了|完|过)?|吃药|用药|用完药|输液|办法).{0,12}(?:变化|区别|复发|反复|还犯)|症状变/) && !has(text, /用药史|有没有用药/)],
