...
const rules = Object.freeze([
  ...
  ["medication_list", (text) => has(text, /(?:平时|平常|长期|常年|每天|固定|常规|规律|常用|常备|早晚|天天|一直备着).{0,14}(?:药|服用|服药|吃|用药)|(?:药|药物|服药|用药).{0,12}(?:平时|平常|长期|常年|每天|固定|常规|规律|常用|天天)|(?:吃|服|用)(?:的)?什么药|现在在吃哪些药|用药史|处方药|药物方面|列一张单子|慢性病.{0,8}吃什么药/) && !has(text, /过敏|allerg|怎么吃|几次|剂量|这回|这次|此次|当前|为这事|为这个|症状|发作|来前|来院前|医院|医生|大夫/) && !has(text, /^(?:平时)?有没(?:有)?(?:长期)?(?:吃|服|用)?药(?:吗)?[？?]?$/)],
