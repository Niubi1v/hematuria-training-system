...
for (const signal of ["正在启动本地患者服务", "127.0.0.1", "Get-FileHash", "netstat.exe", "Get-PackageProcesses", "LocalPort", "$_.Id", "$node.Id", "$llama.Id", "ProcessStartInfo", "UseShellExecute = $false", "llama-server.exe", "node.exe"]) {
