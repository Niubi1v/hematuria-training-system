...
- 本轮另有 21 项人工批准映射按精确来源指纹释放；4 项人工拒绝映射保留原记录，模拟报告不会覆盖既有真实来源。
- 最终医学权威输入含 103 项教学模拟报告、34 项未实施决定和 3 项来源派生报告；运行时对 2692 个医学适用且学生可选的病例×检查组合返回 2692 张非空报告卡，其中 2508 张为固定可重放的新增教学模拟报告，未实施、无病例结果和不可用均为 0。教学模拟不进入诊断或评分。
- 基础运行时队列原有 1023 项等待医学审核，其中 79 项已由最终医学决定覆盖；剩余 944 项继续内部隔离，但学生开立后均显示明确安全终态。另有 1 项医学冲突继续隔离。
- 未审核结果不得进入 evidence graph、诊断或评分；医学适用且学生可选的检查均返回报告卡。
