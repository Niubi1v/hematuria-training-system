...
被测 Production SHA：`3a16f9314d1b3cf50e30bc41dcfeaf19f4fa77a8`。基线 merge 后 QA HEAD：`991ec7605ca9b82c4c4835a9fcb075dfaf770e35`；本轮 QA 报告/测试提交 SHA 以 Git 同步状态为准。
...
| 20 轮性能 | P95 完整回答 `1726ms`、UI 发请求 `45ms`、provider `1297ms`、history-log `6ms`；服务端 firsttoken 字段仅作服务端计时，不冒充浏览器第一个可见文字 |
