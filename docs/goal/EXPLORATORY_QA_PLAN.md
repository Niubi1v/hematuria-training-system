...
状态：执行中；当前 Production Goal 文档基线 `657ba5da8fc6460ad7d0deea882a010c40938b40`，运行时证据代码基线 `3a16f9314d1b3cf50e30bc41dcfeaf19f4fa77a8`；QA 交付分支 `codex/hematuria-exploratory-qa`。
...
- 仍未自动完成的项目按原计划继续：真实网络中断/429/Redis不可用等需要受控故障注入的 Preview 场景、浏览器第一个可见文字计时、真实手机软键盘/safe-area，以及医学/来源审批。没有授权时不主动破坏远程服务，也不把不可测项写成通过。
