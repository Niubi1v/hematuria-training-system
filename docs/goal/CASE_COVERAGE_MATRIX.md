...
- P006–P012真实Preview开放主诉更新为`ZH_LIVE_AI_EN_FAIL_PREVIEW`：三轮自然问法中中文21/21 live_ai、英文21/21 classifier-disabled rule fallback；英文canonical控制7/7进入DeepSeek后被输出过滤为safety boundary。状态仅适用于这7例和这些问法，不外推P013–P042。
